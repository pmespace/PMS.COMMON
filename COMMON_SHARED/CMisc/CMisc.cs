...
namespace PMS.COMMON
{
	...
	static public class CMiscExtensions
	{
		...
		/// <param name="trim">If true [DEFAULT] the string to test is trimmed before testing, processed as is if false</param>
		/// <returns>True if null or Length=0, false otherwise</returns>
	...
	public static class CMisc
	{
		...
		/// <summary>
		/// Verify whether a requested folder is valid and exists, eventually creating it and moving into it.
		/// If the folder isn't right, or can't be created,... then the current folder remains unchanged.
		/// </summary>
