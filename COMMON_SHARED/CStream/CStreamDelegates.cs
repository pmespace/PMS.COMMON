...
namespace COMMON
{
	...
	public class CStreamDelegates
	{
		...
		/// <param name="parameters">Private parameters passed to the thread</param>
		/// <returns>FALSE if the server must stop immediately before receiving any request, TRUE if the server must carry on</returns>
		public delegate bool ServerOnConnectDelegate(TcpClient client, CThreadData threadData, object parameters);
		/// <summary>
		...
		public delegate byte[] ServerOnMessageDelegate(TcpClient client, byte[] request, out bool addBufferSize, CThreadData threadData, object parameters, object o);
		/// <summary>
		...
		/// <param name="threadData">Thread ID as given by the creator of the thread</param>
		/// <param name="parameters">Private parameters passed to the thread</param>
		public delegate void ServerOnDisconnectDelegate(string remoteClient, CThreadData threadData, object parameters);
		/// <summary>
		...
		public delegate byte[] ClientOnReceivedMessageDelegate(byte[] msg, out bool addBufferSize, out int timer, out string header, out bool stopClient, CThreadData threadData, object parameters);
		/// <summary>
		/// Function called inside server context to process a server received message and prepare a reply
		/// </summary>
		/// <param name="msg">Message received from the server as a byte array</param>
		...
		/// <param name="parameters">Private parameters passed to the thread</param>
		/// <returns>A reply to send back in byte array format or NULL if the server must stop receiving messages</returns>
		public delegate void ClientOnSendMessageDelegate(byte[] msg, bool addBufferSize, CThreadData threadData, object parameters);
		/// <summary>
		...
		public delegate bool ClientOnReplyDelegate(byte[] reply, bool error, CThreadData threadData, object parameters);
		#endregion
